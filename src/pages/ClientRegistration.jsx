...
export default function ClientRegistration() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${BASE_URL}/api/admin/register-client`, {
        method: "POST",
        headers: {
    ...
    <div className="max-w-5xl mx-auto pb-12 relative animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Onboard a new purchaser of the FinSaaS software, configure their
          Master Admin, and setup their operational branches.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="bg-gray-50 border-b border-gray-100 px-6 py-4 flex items-center">
            ...
            <h3 className="font-bold text-gray-800">
              1. Company & Master Admin Details
            </h3>
          </div>
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 mt-4 bg-blue-50/50 p-5 rounded-lg border border-blue-100">
              <h4 className="text-sm font-bold text-blue-900 mb-3 flex items-center">
                <Shield className="h-4 w-4 mr-1.5" /> Master Admin Login
                Credentials
              </h4>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      name="masterUsername"
                      value={companyDetails.masterUsername}
                      onChange={handleCompanyChange}
                      className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg outline-none font-mono"
                      placeholder="admin@apex"
                      required
                    />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="password"
                      name="masterPassword"
                      value={companyDetails.masterPassword}
                      onChange={handleCompanyChange}
                      className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg outline-none font-mono"
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="bg-gray-50 border-b border-gray-100 px-6 py-4 flex justify-between items-center">
            <div className="flex items-center">
              ...
              <h3 className="font-bold text-gray-800">
                2. Branch Configurations ({branches.length})
              </h3>
            </div>
            <button
              type="button"
              onClick={addBranch}
              className="flex items-center text-sm font-bold text-blue-600 hover:text-blue-800 bg-blue-50 px-3 py-1.5 rounded-lg transition-colors"
            >
          ...
          <div className="p-6 space-y-6">
            {branches.map((branch, index) => (
              <div
                key={branch.id}
                className="relative p-5 border border-gray-200 rounded-xl bg-white hover:border-blue-300 transition-colors group"
              >
                {branches.length > 1 && (
                  <button
                    type="button"
                    onClick={() => removeBranch(branch.id)}
                    className="absolute -top-3 -right-3 bg-red-100 text-red-600 p-1.5 rounded-full hover:bg-red-600 hover:text-white transition-colors shadow-sm"
                    title="Remove Branch"
                  >
                ...
                <h4 className="text-sm font-bold text-gray-800 mb-4 border-b pb-2">
                  Branch #{index + 1}
                </h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleBranchChange(branch.id, e)}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleBranchChange(branch.id, e)}
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg outline-none uppercase"
                  ...
                  <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-5 bg-gray-50 p-4 rounded-lg mt-2">
                    <div>
                      ...
                      <input
                        type="text"
                        name="branchUsername"
                        value={branch.branchUsername}
                        onChange={(e) => handleBranchChange(branch.id, e)}
                        className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg outline-none font-mono"
                        placeholder="mumbai_mgr"
                        required
                      />
                    </div>
                    <div>
        ...
        <div className="flex justify-end">
          <button
            ...
            className="flex items-center px-8 py-3 bg-green-600 text-white rounded-xl font-bold hover:bg-green-700 shadow-md transition-all disabled:opacity-70"
          >
            {isSubmitting ? (
              "Registering System..."
            ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm transition-opacity duration-300">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full mx-4 flex flex-col items-center transform transition-all animate-fade-in">
            ...
            <p className="text-gray-500 text-center mb-8">
              Company and Branches added successfully!
            </p>
            <button
              onClick={() => {
